...
| `clearButtonAriaLabel` | `clear-button-aria-label` | The label and aria-label of the clear button                                                   | `string`                                          | `'Borrar'`                                      |
...
| `hasClear`             | `has-clear`               | Include a button to clear the value                                                            | `boolean`                                         | `false`                                         |
...
| `icon`                 | `icon`                    | The icon name for the input's icon                                                             | `string`                                          | `undefined`                                     |
| `iconPosition`         | `icon-position`           | The icon position                                                                              | `"left" \| "right"`                               | `InputIconPositions.Left`                       |
...
| `type`                 | `type`                    | The type of the input                                                                          | `"email" \| "search" \| "tel" \| "text" \| "url"` | `InputTextTypes.Text`                           |
