...
| ------------------- | --------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------- | ----------------------------------------------- |
| `autocomplete`      | `autocomplete`        | Whether the input will be autocompleted.                                                       | `"current-password" \| "new-password"`        | `undefined`                                     |
...
| `feedback`          | `feedback`            | The type of the feedback. If 'error' the error feedback will be shown                          | `"error" \| "none" \| "success" \| "warning"` | `InputFeedbackTypes.None`                       |
| `feedbackText`      | `feedback-text`       | The message for the feedback.                                                                  | `"error" \| "none" \| "success" \| "warning"` | `InputFeedbackTypes.Error`                      |
...
| `labelHidePassword` | `label-hide-password` | The accesible text to button Hide Password                                                     | `string`                                      | `'Ocultar password'`                            |
| `labelShowPassword` | `label-show-password` | The accesible text to button Show Password                                                     | `string`                                      | `'Ver password'`                                |
...
| `pattern`           | `pattern`             | Specifies a regular expression that the input element's value is checked                       | `string`                                      | `undefined`                                     |
...
| `tooltipWidth`      | `tooltip-width`       | The max width to the text in the tooltip                                                       | `any`                                         | `undefined`                                     |
...
| `athClear`  | Emitted when the component is cleared                                                      | `CustomEvent<string>` |
